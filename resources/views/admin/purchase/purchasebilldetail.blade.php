  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('purchase_bil_pay_part')}}" method="post">
          @csrf
          <input type="hidden" name="bill_id" value="{{$bill->id}}" required>
          <input type="hidden" name="supp_id" value="{{$bill->supplier_id}}" required>
  ...
  <div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
          ...
          <input type="text" class="form-control" value="{{$bill->supplier->tree->id_code}}" disabled>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="form-group">
          ...
          <input type="text" class="form-control" value="{{$bill->supplier->tree->balance}}" disabled>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="form-group">
          ...
          <input type="text" class="form-control" value="{{$bill->store->store_name}}" readonly>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="form-group">
          <label for="email">المبلغ المتبقي</label>
          <input type="number" step="0.001" class="form-control" value="{{$bill->remaining_amount}}" readonly>
        </div>
    </div>
...
<div class="table-responsive">
        ...
        <th>الاجمالي</th>
          ...
          @foreach($bill->bill_products as $item)
            <tr>  
              <td><input type="text"  class="form-control" value="{{$item->product_date->product->item->name}}"readonly/></td> 
              <td><input type="text"  class="form-control" value="{{$item->product_date->production_date}}" readonly/></td> 
              <td><input type="text"  class="form-control" value="{{$item->product_date->expire_date}}" readonly/></td> 
              <td><input type="number" step="0.001"  class="form-control" value="{{$item->product_date->cost}}" readonly/></td> 
...
<script type="text/javascript">
  function openmodle(){
    document.getElementById("iframe").src="{{url('printpurchasebill')}}/{{ $bill->id }}";
  }
</script>
    @endsection
