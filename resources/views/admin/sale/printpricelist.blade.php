    ...
    <center>
        <div id="elem" style="text-align:center;width:250px;height:auto;font-size:12px;">
            ...
            <table class="detail" width="100%">
                <tr>
                    <td>رقم</td>
                    <td>{{$find->pricelist_number}}</td>
                    <td>وقت</td>
                    <td>{{$find->created_at}}</td>
                </tr>
                <tr>
                    <td>عميل</td>
                    <td>{{$find->customer->name}}</td>
                </tr>
            </table>
            <hr>
            <table>
            ...
            <hr>
            <span style="float:left;">{{$find->total_before_tax}} ر.س</span><span style="float:right;">اجمالي فرعي</span>
            <br>
            <span style="float:left;">{{$find->expire_date}} </span><span style="float:right;">تاريخ الإنتهاء</span>
            <br>
            <span style="float:left;">{{$find->date}} </span><span style="float:right;">التاريخ</span>
            {{--            <span style="float:left;">{{$find->date}}</span><span style="float:right;">التاريخ</span>--}}
            <br>
            <span >الاجمالي</span>      <span>{{$find->total}} ر.س</span>
            <br>
            <br>
            <hr>
