...
<div class="container" id="myUL">
 ...
 <li><a><div style="width:24%;;height:120px;" class="filterDiv {{$index+1}}" onclick="addCode({{$index}})">
...
<script>
  ...
  var proBarcode = document.getElementById("barcodeScannerVal").value;
...
{
  //console.log(productList[i].product.barcode);
	if(productList[i].product != null){
	if(productList[i].product.barcode == proBarcode){
    console.log(productList[i]);
    document.getElementById("add_to_me").innerHTML += '<tr><td>'+ productList[i].name_ar +'</td><td>'+ productList[i].default_sale_price+' SAR </td><td> <input type="text" value="1" style="width:40px;float:right;"></td>'+'<td>-</td>'+'<td>-</td>'+'<td>-'+'<button style="float:right;width: 25px; height: 25px; border-radius: 25px;font-size:12px;padding:4px;" type="button" class="btn btn-danger remove-tr"><i class="fa fa-trash"></i></button></td>'+'</tr>'; 
    //break;
  }
