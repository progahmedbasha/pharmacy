...
@section('content')
    ...
    <div class="analytics-sparkle-area">
        <div class="container-fluid">
            <br>
            <button type="button" class="btn btn-success" onclick='openmodle("{{url('printSaleBack',$return_bill->id)}}")'><i class="fa fa-print" aria-hidden="true"></i> طباعة فاتورة الإرجاع</button>
...
{{--                                    <input type="hidden" name="supp_id" value="{{$return_bill->bill->customer_id}}" required>--}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$return_bill->bill->customer->name}}" disabled>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$return_bill->bill->customer->tree->id_code}}" disabled>
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered table-striped main" id="dynamicTable">
                                    ...
                                    @foreach($return_bill->return_products as $item)
                                        @if($item->bill_products)
                                            <tr>
                                                <td>{{$item->bill_products->name_ar}}</td>
{{--                                                <td>{{$item->bill_products->product_date->product_date->production_date}}</td>--}}
{{--                                                <td>{{$item->bill_products->product_date->product_date->expire_date}}</td>--}}
                                                <td>{{$item->amount}}</td>
                                                <td>{{$item->quantity}}</td>
                                                <td>{{$item->tax}}</td>
                                                <td>{{$item->amount}}</td>
