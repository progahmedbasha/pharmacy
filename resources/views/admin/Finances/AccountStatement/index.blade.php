        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('allAccountStatement')}}" method="post" id="Form">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4 col-md-6  mb-4">
                                    <label class="label mb-2 " for="dayeenSelect">الحساب</label>
                                    <select class="form-control select2" name="account" data-validation="required" >
                                        <option value="" selected>إختر</option>
                                        @foreach($accountes as $account)
