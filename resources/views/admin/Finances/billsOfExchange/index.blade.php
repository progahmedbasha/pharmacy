...
{{--    @include('layouts.loader.loaderCss')--}}
    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a href="{{route('billsOfExchange.create')}}" id="" class="btn mb-2 btn-success "> أضف <span class="icon-add_circle"></span>  </a>
    ...
    <script>
        ...
        $("#test").DataTable({
            ...
            "searching": true,
            'iDisplayLength': 20,
            "ajax": "{{route('billsOfExchange.index')}}",
            "columns": [
        ...
        $(document).on('click','#addButton',function (e) {
            e.preventDefault()
            var url = '{{route('billsOfExchange.create')}}';
            $.ajax({
                url: url,
                type: 'GET',
                beforeSend: function(){
        ...
        $(document).on('click','.editButton',function (e) {
            ...
            var url = '{{route('billsOfExchange.edit',":id")}}';
        ...
        $(document).on('click','.showButton',function (e) {
            ...
            var url = '{{route('billsOfExchange.show',":id")}}';
            url = url.replace(':id', id);
        ...
        $(document).on('click', '.', function () {
            ...
            swal({
                ...
                var url = '{{ route("billsOfExchange.destroy", ":id") }}';
                url = url.replace(':id', id);
                console.log(url);
                $.ajax({
                    url: url,
