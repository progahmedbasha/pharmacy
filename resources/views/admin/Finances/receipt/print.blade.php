...
<fieldset style="font-weight: bolder">
    <div class="row" dir="rtl" style="margin: 10px">
        <div class="col-sm-4"  style="display: inline-block">إستلام من : </div>
        <div class="col-sm-8" style="display: inline-block">{{$find->debit_rl ? $find->creditor_rl->name:''}}</div>
    </div>
    ...
    <div class="row" dir="rtl" style="margin: 10px">
        ...
        <div class="col-sm-3 " style="display: inline-block">بنك: {{$find->payment_type == 'check'?$find->debit_rl->name:'........................'}}</div>
        <div style="display: inline-block" class="col-sm-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
