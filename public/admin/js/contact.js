            ...
            $html = '<tr class="search-items">' +
                            ...
                            '<td>' +
                                '<div class="d-flex align-items-center">' +
                                                  '<img src="../assets/images/background/user1.jpg" alt="avatar" class="rounded-circle" width="50">' +
                                                  '<div class="ms-3">' +
                                                        '<div class="user-meta-info">' +
                                                                '<h6 class="user-name mb-0 font-weight-medium" data-name='+ $_nameValue +'>'+ $_nameValue +'</h6>' +
                            ...
                            '</td>'+
                            '<td>' +
                                                '<span class="usr-email-addr text-muted font-weight-medium" data-email='+ $_emailValue +'>' + $_emailValue +'</span>' +
                                        '</td>' +
                                        '<td>' +
                                                '<span class="usr-location text-muted font-monospace font-weight-medium" data-location='+ $_locationValue +'>' + $_locationValue +'</span>' +
                                        '</td>' +
                                        '<td>' +
                                                '<span class="usr-ph-no text-muted font-weight-medium" data-phone='+ $_phoneValue +'>'+ $_phoneValue +'</span>' +
                                        '</td>' +
                                        '<td>' +
