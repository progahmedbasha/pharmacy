...
class AdminCashMovementController extends Controller
{
    ...
    public function Search(Request $request){
        if ($request->has('_token')){
            ...
            if ($request->box != null) {
                ...
                $find->where('account_id',$request->box);
            }
            ...
            $this->add_log_activity(null,auth()->user(),'تم دخول صفحة حركة ال.');

            $boxes = Account::FilterForPurchases(6)->get();

            return view('admin.modules.Finances.CashMovement.index',compact('boxes'));
